<footer id="footer" class="container" style="margin-top: 5px;">
    <div class="row">
      <div class="col-lg-12">
        ...
        <p class="footer-text text-center">Powered by <a href="https://baraveli.xyz/"
            style="color: #5676F7;">Baraveli</a>.</p>
      </div>
    </div>
  </footer>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.24.0/moment.min.js"
    ...
    <script src="/js/vue-moment-lib.umd.min.js"></script>
